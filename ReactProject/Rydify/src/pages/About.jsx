...
function About(){
    return(
        <>
           <div className="wt-bnr-inr site-bg-dark  twm-primary-overlay-wrap" style={{backgroundImage:"url(images/banner/banner-10.jpg)"}}>
            ...
            <div className="section-full site-bg-light twm-abus-section-wrap wow fadeInDown" data-wow-offset="100" data-wow-delay="0.2">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 twm-abus2-right-pic" style={{backgroumdImage:"url(images/ab-us.jpg)" }}>
